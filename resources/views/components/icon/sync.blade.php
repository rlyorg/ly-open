<svg fill="white" {{ $attributes->merge(['class' => 'inline-block w-5 h-5']) }} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
